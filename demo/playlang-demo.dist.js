...
/***/ function(module, exports, __webpack_require__) {
	...
	Runtime.prototype.loop = function (step) {
	  ...
	  this.queue = this.queue.then(function () {
	    var loopqueue = _this8.looping.loopingpromise.promise;
	    ...
	    var generatePromise = function generatePromise() {
	      var newPromise = step(_this8.result);
	      if (newPromise.next) {
	    ...
	    _this8.looping.loopingpromise.promise = loopqueue.then(function () {
	      if (pred(_this8.result)) {
	        _this8.looping.loopingpromise.promise = loopqueue.then(generatePromise);
	      } else {
