...
/***/ function(module, exports, __webpack_require__) {
	...
	playlang.start().next(function () {
	  console.log('>>>>> #0');return 3;
	}).next(function (x) {
	  console.log('>>>>> #1', x);return x + 4;
	}).next(function (x) {
	  console.log('>>>>> #2', x);return x + 5;
	}).all(function () {
	  return 1;
	}, function () {
	  return new _Promise(function (r, j) {
	    setTimeout(function () {
	      r(20);
	    }, 1000);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	Runtime.prototype.all = function () {
	  ...
	  var candidates = _Array$from(arguments);
	  this.queue = this.queue.then(function () {
	    return _Promise.all(candidates.map(function (step) {
	      return generatePromise(step);
	    })).then(updateResult);
	  })['catch'](function (err) {
	    _this10.reject(err);
